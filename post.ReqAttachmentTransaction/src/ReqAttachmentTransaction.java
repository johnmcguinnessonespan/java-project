...
public class ReqAttachmentTransaction {
  ...
  public static final String PACKAGE_TITLE = "ReqAttachmentTransaction";
  ...
  public static void main(String[] args) throws IOException, EslServerException {
    ...
    // Signer signer =
    // SignerBuilder.newSignerWithEmail("john.cyclist.mcguinness+attachment@gmail.com")
    // .withFirstName(prop.getProperty("FORENAME"))
    ...
    // signerAttachments =
    // retrievedPackage.getSigner(email1).getAttachmentRequirements();
    // signerAtt = signerAttachments.get(0);
    //
    // byte[] attachmentForSignerFileContent = new
    // StreamDocumentSource(attachmentInputStream).content();
    ...
    // eslClient.getAttachmentRequirementService().downloadAttachmentFile(packageId,
